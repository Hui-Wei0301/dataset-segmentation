...
def main(args):
    ...
    bert_vec = read_sent_bert(bert_vec, '/home/weihui/huiwei/bert/bert_emb_train')
    bert_vec = read_sent_bert(bert_vec, '/home/weihui/huiwei/bert/bert_emb_dev')
    bert_vec = read_sent_bert(bert_vec, '/home/weihui/huiwei/bert/bert_emb_test')
